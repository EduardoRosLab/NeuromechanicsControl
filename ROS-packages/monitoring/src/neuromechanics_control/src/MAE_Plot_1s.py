...
class MaeplotAnimation(matplotlib.animation.TimedAnimation):
	...
	def __init__(self):
		...
		rospy.Subscriber(self.currentTopic, neuromechanics_control.msg.AnalogCompact, self.CurrentCallback, queue_size=None)
		rospy.Subscriber(self.desiredTopic, neuromechanics_control.msg.AnalogCompact, self.DesiredCallback, queue_size=None)
