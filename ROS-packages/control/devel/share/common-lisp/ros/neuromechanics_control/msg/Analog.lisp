...
(cl:defmethod cl:initialize-instance :after ((m <Analog>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Analog)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name neuromechanics_control-msg:<Analog> is deprecated: use neuromechanics_control-msg:Analog instead.")))
...
(cl:defmethod data-val ((m <Analog>))
