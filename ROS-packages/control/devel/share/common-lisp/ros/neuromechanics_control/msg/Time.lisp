...
(cl:defmethod cl:initialize-instance :after ((m <Time>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Time)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name neuromechanics_control-msg:<Time> is deprecated: use neuromechanics_control-msg:Time instead.")))
