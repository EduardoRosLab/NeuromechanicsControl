...
#ifndef MUSCLEDYNAMICSCOCONTRACTION_H_
#define MUSCLEDYNAMICSCOCONTRACTION_H_
 ...
 */
class MuscleDynamicsCocontraction {
private:
...
public:
	 ...
	 */
	MuscleDynamicsCocontraction(std::string input_agonist_antagonist_topic,
	 ...
	 */
	virtual ~MuscleDynamicsCocontraction();

};

#endif /* MUSCLEDYNAMICSCOCONTRACTION_H_ */
