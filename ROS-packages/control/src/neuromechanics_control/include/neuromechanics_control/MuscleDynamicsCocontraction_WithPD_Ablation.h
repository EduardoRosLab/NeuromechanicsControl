/***************************************************************************
 *                  MuscleDynamicsCocontraction_WithPD_Ablation.h          *
 *                           -------------------                           *
...
#ifndef MUSCLEDYNAMICSCOCONTRACTION_WITHPD_ABLATION_H_
#define MUSCLEDYNAMICSCOCONTRACTION_WITHPD_ABLATION_H_
 ...
 */
class MuscleDynamicsCocontraction_WithPD_Ablation {
private:
...
public:
	 ...
	 */
	MuscleDynamicsCocontraction_WithPD_Ablation(std::vector<double> kp_gain,
		std::vector<double> kd_gain,
		double PD_min_output,
		double PD_max_output,
	 ...
	 */
	virtual ~MuscleDynamicsCocontraction_WithPD_Ablation();

};

#endif /* MuscleDynamicsCocontraction_WithPD_Ablation_H_ */
