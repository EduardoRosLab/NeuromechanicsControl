...
#include <neuromechanics_control/SynchronizerDynParametersConfig.h>
 ...
 */
 ...
 private:
  ...
  dynamic_reconfigure::Server<neuromechanics_control::SynchronizerDynParametersConfig> dr_srv_;
  //! ROS node handle.
  ros::NodeHandle *nh_;
  //! ROS node handle.
  ros::NodeHandle *pnh;
 public:
    ...
    *
    */
   void callback(neuromechanics_control::SynchronizerDynParametersConfig &config, uint32_t level);
