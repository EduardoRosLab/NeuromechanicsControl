/***************************************************************************
 *                  MuscleDynamicsCocontraction_DirectPD.h 				         *
 *                           -------------------                           *
...
#ifndef MUSCLEDYNAMICSCOCONTRACTION_DIRECTPD_H_
#define MUSCLEDYNAMICSCOCONTRACTION_DIRECTPD_H_
 ...
 */
class MuscleDynamicsCocontraction_DirectPD {
private:
	...
	std::priority_queue<neuromechanics_control::AnalogCompact, std::vector<neuromechanics_control::AnalogCompact>, analog_comparison > activity_queue_desired_velocity;
	...
	std::vector<double> alpha_reflex;
	...
	// Current values
	std::vector<double> current_position, current_velocity, desired_position, desired_velocity, agonist_signal, antagonist_signal;
	...
	// Value of the PD output
	std::vector<double> pd_output;
	...
	double last_time_current_pos, last_time_current_vel, last_time_desired_pos, last_time_desired_vel, last_time_input_control, last_time_agonist, last_time_antagonist;

	// Last cocontraction value used
	double last_cocontraction;
	...
	// Callback function for reading input activity
	void DesiredVelocityCallback(const neuromechanics_control::AnalogCompact::ConstPtr& msg);
...
public:
	 ...
	 */
	MuscleDynamicsCocontraction_DirectPD(std::vector<double> kp_gain,
		std::vector<double> kd_gain,
		std::vector<double> PD_min_output,
		std::vector<double> PD_max_output,
	 ...
	 */
	virtual ~MuscleDynamicsCocontraction_DirectPD();

};

#endif /* MuscleDynamicsCocontraction_DirectPD_H_ */
