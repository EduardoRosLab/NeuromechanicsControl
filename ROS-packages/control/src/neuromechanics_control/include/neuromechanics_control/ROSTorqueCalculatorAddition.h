...
private:
	...
	std::priority_queue<neuromechanics_control::AnalogCompact, std::vector<neuromechanics_control::AnalogCompact>, analog_comparison > activity_queue_torque_1;

	// Queue of actual position analog signals not processed yet
	std::priority_queue<neuromechanics_control::AnalogCompact, std::vector<neuromechanics_control::AnalogCompact>, analog_comparison > activity_queue_torque_2;
	...
	void Torque1Callback(const neuromechanics_control::AnalogCompact::ConstPtr& msg);

	// Callback function for reading input activity
	void Torque2Callback(const neuromechanics_control::AnalogCompact::ConstPtr& msg);
