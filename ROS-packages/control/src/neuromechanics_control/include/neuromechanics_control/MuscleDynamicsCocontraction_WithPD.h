/***************************************************************************
 *                        MuscleDynamicsCocontraction_WithPD.h                    *
 *                           -------------------                           *
...
#ifndef MUSCLEDYNAMICSCOCONTRACTION_WITHPD_H_
#define MUSCLEDYNAMICSCOCONTRACTION_WITHPD_H_
 ...
 */
class MuscleDynamicsCocontraction_WithPD {
private:
...
public:
	 ...
	 */
	MuscleDynamicsCocontraction_WithPD(std::vector<double> kp_gain,
		std::vector<double> kd_gain,
		double PD_min_output,
		double PD_max_output,
	 ...
	 */
	virtual ~MuscleDynamicsCocontraction_WithPD();

};

#endif /* MuscleDynamicsCocontraction_WithPD_H_ */
