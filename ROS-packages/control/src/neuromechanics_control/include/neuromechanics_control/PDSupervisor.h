...
// 	void CurrentPositionCallback(const neuromechanics_control::AnalogCompactDelay::ConstPtr& msg);
// 	void CurrentVelocityCallback(const neuromechanics_control::AnalogCompactDelay::ConstPtr& msg);
//
