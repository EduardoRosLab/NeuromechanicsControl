...
#include <neuromechanics_control/DelayGeneratorDynParametersConfig.h>
 ...
 */
 ...
 private:
  ...
  dynamic_reconfigure::Server<neuromechanics_control::DelayGeneratorDynParametersConfig> dr_srv_;
  //! ROS node handle.
  ros::NodeHandle *nh_;
  //! ROS node handle.
  ros::NodeHandle *pnh;
 public:
    ...
    *
    */
   void callback(neuromechanics_control::DelayGeneratorDynParametersConfig &config, uint32_t level);
