/***************************************************************************
 *                       MuscleDynamicsCocontraction_WithPD.cpp            *
 *                           -------------------                           *
...
#include "neuromechanics_control/MuscleDynamicsCocontraction_WithPD.h"
#include "neuromechanics_control/AnalogCompact.h"
#include "neuromechanics_control/AnalogCompact_AgonistAntagonist.h"


void MuscleDynamicsCocontraction_WithPD::CurrentPositionCallback(const neuromechanics_control::AnalogCompact::ConstPtr& msg){
...
void MuscleDynamicsCocontraction_WithPD::CurrentVelocityCallback(const neuromechanics_control::AnalogCompact::ConstPtr& msg){
	// Check if the signal should have been processed previously
...
void MuscleDynamicsCocontraction_WithPD::DesiredPositionCallback(const neuromechanics_control::AnalogCompact::ConstPtr& msg){
	// Check if the signal should have been processed previously
...
void MuscleDynamicsCocontraction_WithPD::DesiredVelocityCallback(const neuromechanics_control::AnalogCompact::ConstPtr& msg){
	// Check if the signal should have been processed previously
...
void MuscleDynamicsCocontraction_WithPD::CocontractionCallback(const neuromechanics_control::AnalogCompact::ConstPtr& msg){
...
int MuscleDynamicsCocontraction_WithPD::FindJointIndex(std::vector<std::string> strvector, std::string name){
...
MuscleDynamicsCocontraction_WithPD::MuscleDynamicsCocontraction_WithPD(
				...
				PD_max_output(PD_max_output)
{
	...
	this->subscriber_current_position = this->NodeHandler.subscribe(current_position_topic, 10.0, &MuscleDynamicsCocontraction_WithPD::CurrentPositionCallback, this);
	this->subscriber_current_velocity = this->NodeHandler.subscribe(current_velocity_topic, 10.0, &MuscleDynamicsCocontraction_WithPD::CurrentVelocityCallback, this);
	this->subscriber_desired_position = this->NodeHandler.subscribe(desired_position_topic, 10.0, &MuscleDynamicsCocontraction_WithPD::DesiredPositionCallback, this);
	this->subscriber_desired_velocity = this->NodeHandler.subscribe(desired_velocity_topic, 10.0, &MuscleDynamicsCocontraction_WithPD::DesiredVelocityCallback, this);

	this->subscriber_cocontraction = this->NodeHandler.subscribe(cocontraction_input_topic, 10.0, &MuscleDynamicsCocontraction_WithPD::CocontractionCallback, this);
...
void MuscleDynamicsCocontraction_WithPD::UpdateTorque(ros::Time current_time){
...
void MuscleDynamicsCocontraction_WithPD::CleanQueue(std::priority_queue<neuromechanics_control::AnalogCompact, std::vector<neuromechanics_control::AnalogCompact>, analog_comparison > & queue,
