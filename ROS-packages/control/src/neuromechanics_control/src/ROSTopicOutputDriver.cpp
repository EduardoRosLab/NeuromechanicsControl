...
#include "neuromechanics_control/ROSTopicOutputDriver.h"
...
ROSTopicOutputDriver::ROSTopicOutputDriver(string TopicName, unsigned int MaxSpikeBuffered, double InitSimulationRosTime, double output_delay):
	...
	this->Publisher_group = this->NodeHandler.advertise<neuromechanics_control::Spike_group>(TopicName, MaxSpikeBuffered);
