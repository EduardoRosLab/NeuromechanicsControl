...
int main(int argc, char **argv)
{
	...
	std::string input_agonist_antagonist_topic,  current_position_topic, current_velocity_topic, desired_position_topic,
	...
	std::vector<double> muscle_gain, muscle_stiffness_gain, muscle_tonic_stiffness, damping, cocontraction, resting_position, max_torque, max_deviation;
	...
	private_node_handle_.getParam("input_agonist_antagonist_topic", input_agonist_antagonist_topic);
	...
	MuscleDynamicsCocontraction objMuscleDynamics(input_agonist_antagonist_topic,
