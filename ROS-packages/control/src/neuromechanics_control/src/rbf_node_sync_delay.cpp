 ...
 ***************************************************************************/
 ...
 #include <neuromechanics_control/ROSRBFBank_delay.h>
 ...
 int main(int argc, char **argv)
 {
  ...
  // RBF node clock.
  if (use_sim_time){
		ROS_DEBUG("RBF: Subscribing to topic /clock");
  ...
  // Create the output spike publisher
 	ros::Publisher output_publisher = nh.advertise<neuromechanics_control::Spike>(output_topic+"OLD", 1e9);
