/***************************************************************************
 *                       MuscleDynamicsCocontraction.cpp                   *
 *                           -------------------                           *
...
#include "neuromechanics_control/MuscleDynamicsCocontraction.h"
#include "neuromechanics_control/AnalogCompact.h"
#include "neuromechanics_control/AnalogCompact_AgonistAntagonist.h"


void MuscleDynamicsCocontraction::CurrentPositionCallback(const neuromechanics_control::AnalogCompact::ConstPtr& msg){
...
void MuscleDynamicsCocontraction::CurrentVelocityCallback(const neuromechanics_control::AnalogCompact::ConstPtr& msg){
	// Check if the signal should have been processed previously
...
void MuscleDynamicsCocontraction::DesiredPositionCallback(const neuromechanics_control::AnalogCompact::ConstPtr& msg){
	// Check if the signal should have been processed previously
...
void MuscleDynamicsCocontraction::AgonistAntagonistCallback(const neuromechanics_control::AnalogCompact_AgonistAntagonist::ConstPtr& msg){
	// Check if the signal should have been processed previously
...
void MuscleDynamicsCocontraction::CocontractionCallback(const neuromechanics_control::AnalogCompact::ConstPtr& msg){
...
int MuscleDynamicsCocontraction::FindJointIndex(std::vector<std::string> strvector, std::string name){
...
MuscleDynamicsCocontraction::MuscleDynamicsCocontraction(
				...
				max_deviation(max_deviation)
{
	...
	this->subscriber_current_position = this->NodeHandler.subscribe(current_position_topic, 10.0, &MuscleDynamicsCocontraction::CurrentPositionCallback, this);
	this->subscriber_current_velocity = this->NodeHandler.subscribe(current_velocity_topic, 10.0, &MuscleDynamicsCocontraction::CurrentVelocityCallback, this);
	this->subscriber_desired_position = this->NodeHandler.subscribe(desired_position_topic, 10.0, &MuscleDynamicsCocontraction::DesiredPositionCallback, this);
	this->subscriber_agonist_antagonist = this->NodeHandler.subscribe(input_agonist_antagonist_topic, 10.0, &MuscleDynamicsCocontraction::AgonistAntagonistCallback, this);
	this->subscriber_cocontraction = this->NodeHandler.subscribe(cocontraction_input_topic, 10.0, &MuscleDynamicsCocontraction::CocontractionCallback, this);
...
void MuscleDynamicsCocontraction::UpdateTorque(ros::Time current_time){
...
void MuscleDynamicsCocontraction::CleanQueue(std::priority_queue<neuromechanics_control::AnalogCompact, std::vector<neuromechanics_control::AnalogCompact>, analog_comparison > & queue,
