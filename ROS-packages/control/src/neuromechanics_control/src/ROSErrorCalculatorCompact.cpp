...
#include "neuromechanics_control/ROSErrorCalculatorCompact.h"
#include "neuromechanics_control/AnalogCompact.h"

void ROSErrorCalculatorCompact::PositionPlusCallback(const neuromechanics_control::AnalogCompact::ConstPtr& msg){
...
void ROSErrorCalculatorCompact::PositionMinusCallback(const neuromechanics_control::AnalogCompact::ConstPtr& msg){
	// Check if the spike should have been processed previously
...
void ROSErrorCalculatorCompact::VelocityPlusCallback(const neuromechanics_control::AnalogCompact::ConstPtr& msg){
	// Check if the spike should have been processed previously
...
void ROSErrorCalculatorCompact::VelocityMinusCallback(const neuromechanics_control::AnalogCompact::ConstPtr& msg){
	// Check if the spike should have been processed previously
...
void ROSErrorCalculatorCompact::CleanQueue(std::priority_queue<neuromechanics_control::AnalogCompact, std::vector<neuromechanics_control::AnalogCompact>, analog_comparison > & queue,
