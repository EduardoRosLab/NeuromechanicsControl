...
#include "neuromechanics_control/ROSTorqueCalculatorAddition.h"
#include "neuromechanics_control/AnalogCompact.h"

void ROSTorqueCalculatorAddition::Torque1Callback(const neuromechanics_control::AnalogCompact::ConstPtr& msg){
...
void ROSTorqueCalculatorAddition::Torque2Callback(const neuromechanics_control::AnalogCompact::ConstPtr& msg){
	// Check if the spike should have been processed previously
...
void ROSTorqueCalculatorAddition::CleanQueue(std::priority_queue<neuromechanics_control::AnalogCompact, std::vector<neuromechanics_control::AnalogCompact>, analog_comparison > & queue,
