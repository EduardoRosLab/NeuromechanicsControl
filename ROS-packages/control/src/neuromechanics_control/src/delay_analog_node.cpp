...
int main(int argc, char **argv)
{
	...
	ros::Publisher output_publisher = nh.advertise<neuromechanics_control::AnalogCompact>(output_topic, 1e9);
	...
	message_filters::Subscriber<neuromechanics_control::AnalogCompact> input_subscriber (nh, input_topic, 1e9, ros::TransportHints(), &CallbackQueue);
	message_filters::TimeSequencer<neuromechanics_control::AnalogCompact> seq(input_subscriber, ros::Duration(delay), ros::Duration(0.001), 1e9, nh);
