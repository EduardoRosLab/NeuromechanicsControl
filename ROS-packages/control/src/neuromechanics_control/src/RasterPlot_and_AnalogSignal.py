...
##**************************************************************************
 #                       RasterPlot_and_AnalogSignal.py                    *
 #                           -------------------                           *
...
from neuromechanics_control.cfg import DynParametersConfig
...
class RasterplotAnimation(matplotlib.animation.TimedAnimation):
	...
	def new_figure(self):
		...
		self.spike_subscriber = rospy.Subscriber(self.spike_inputTopic, neuromechanics_control.msg.Spike_group, self.SpikeCallback, queue_size=None)
		self.analog_subscriber = rospy.Subscriber(self.analog_inputTopic, neuromechanics_control.msg.AnalogCompact, self.AnalogCallback, queue_size=None)
	...
	def __init__(self):
		...
		# being showed.
		self.spike_subscriber = rospy.Subscriber(self.spike_inputTopic, neuromechanics_control.msg.Spike, self.SpikeCallback, queue_size=None)
		self.spike_subscriber.unregister()
