...
SynchronizerDynParams::SynchronizerDynParams(ros::NodeHandle *nh, ros::NodeHandle *pnh) : nh_(nh), pnh(pnh), dr_srv_(*pnh), paused(false), stop_ts(false), time_stamp(0.0) {
	dynamic_reconfigure::Server<neuromechanics_control::SynchronizerDynParametersConfig>::CallbackType cb;
...
void SynchronizerDynParams::callback(neuromechanics_control::SynchronizerDynParametersConfig &config, uint32_t level) {
